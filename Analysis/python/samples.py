...
SAMPLE_DICTS = {
    'qqZZ-EWK': {'title': 'q#bar{q} #rightarrow ZZjj EWK'    , 'fnames':['ZZTo4l_2Jets_EW']},
    'qqZZ-int': {'title': 'q#bar{q} #rightarrow ZZjj interf.', 'fnames':['ZZTo4l_2Jets_EW_QCD']},
    'qqZZ-QCD': {'title': 'q#bar{q} #rightarrow ZZjj QCD'    , 'fnames':['ZZTo4l_2Jets_QCD']},
    ...
    'qqZZ-1J' : {'title': 'q#bar{q} #rightarrow ZZ+1j'       , 'fnames':['ZZTo4l_1Jets']},
    'qqZZ'    : {'title': 'q#bar{q} #rightarrow ZZ Powheg'   , 'fnames':['ZZTo4l']},
